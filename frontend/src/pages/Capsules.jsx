...
const Capsules = () => {
  ...
  const configurations = [
    {
      title: 'Базовая',
      features: ['Каркас из ЛСТК', 'Стеновые панели', 'Кровля', 'Окна и двери']
    },
    {
      title: 'Стандартная',
      features: ['Всё из базовой', 'Утепление', 'Внутренняя отделка', 'Электрика']
    },
    {
      title: 'Премиум',
      features: ['Всё из стандартной', 'Система вентиляции', 'Отопление', 'Сантехника']
    }
  ];
