  ...
  const gallery = [
    {
      image: module1,
      caption: 'Баня 21 м²',
      meta: 'Компактный ЛСТК-модуль'
    },
    {
      image: module2,
      caption: 'Баня 54 м²',
      meta: 'Серийное решение'
    },
    {
      image: module3,
      caption: 'Баня 48 м²',
      meta: 'Функциональный формат'
    },
    {
      image: module4,
      caption: 'Модульная баня 24 м²',
      meta: 'Универсальный модуль'
    },
    {
      image: module5,
      caption: 'Баня 24 м²',
      meta: 'Компактный формат'
    },
    {
      image: module6,
      caption: 'Баня 24 м²',
      meta: 'Типовой ЛСТК-модуль'
    }
  ];
  ...
  return (
    <div className="product-page">
      ...
      <section className="gallery-note">
        <div className="container">
          <div className="gallery-note__content">
            <h3>Принципы проектирования</h3>
            <p>
              Модульные бани в данном разделе представлены как частный формат функциональных зданий с понятной логикой
              эксплуатации и серийного производства. Основа решений — типовая инженерная система ЛСТК.
            </p>
          </div>
        </div>
      </section>
