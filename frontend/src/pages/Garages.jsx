...
const Garages = () => {
  ...
  const configurations = [
    {
      title: 'Стандартный',
      features: ['Каркас из ЛСТК', 'Профнастил', 'Ворота', 'Вентиляция']
    },
    {
      title: 'Утеплённый',
      features: ['Всё из стандартного', 'Утепление 100мм', 'Внутренняя отделка', 'Электрика']
    },
    {
      title: 'Премиум',
      features: ['Всё из утеплённого', 'Автоматические ворота', 'Отопление', 'Система безопасности']
    }
  ];
