        ...
        <div className="container">
          <div className="mission-content">
            <SectionHeader
              eyebrow="Миссия"
              title="Наша миссия"
              subtitle="Создавать функциональные металлоконструкции промышленного класса без декоративной избыточности — с точным расчётом, предсказуемым результатом и стабильным качеством"
            />
            <p className="body-lg">
              Мы работаем по инженерной логике: считаем нагрузки, стандартизируем узлы, оптимизируем производство и обеспечиваем повторяемость решений от проекта к проекту. Наша задача — чтобы каждая конструкция была понятной на этапе проектирования, надёжной в эксплуатации и прозрачной по срокам и стоимости.
            </p>
          </div>
        </div>
      </section>
