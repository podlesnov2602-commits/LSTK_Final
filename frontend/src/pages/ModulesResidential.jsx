  ...
  const pricingCards = [
    {
      ...
      title: 'Дом 100–140 м²',
      price: 'Формат: базовое инженерное решение',
      description:
        'Лёгкий ЛСТК-каркас под индивидуальную планировку и быстрый ввод в эксплуатацию. Подходит для частного строительства и типовых жилых проектов.',
      markers: [
        'Расчёт снеговых и ветровых нагрузок',
        'Комплектация КМД',
        'Маркировка и упаковка под монтаж',
        'Совместимость с фасадами и инженерией'
      ]
    },
    {
      meta: 'ЖИЛОЕ ЗДАНИЕ 2 ЭТАЖА',
      title: 'Дом 150–200 м²',
      price: 'Формат: расширенное инженерное решение',
      description:
        'Двухэтажный дом с заводской подготовкой узлов и контролем геометрии. Оптимален для постоянного проживания и сложных планировок.',
      markers: [
        'Планировки под смешанные сценарии проживания',
        'Усиленные сечения под перекрытия',
        'Комплектация крепежом и схемами монтажа',
        'Подготовка под чистовые фасады'
      ]
    },
    {
      meta: 'ЖИЛОЕ ЗДАНИЕ 2–3 ЭТАЖА',
      title: 'Дом 200–300 м²',
      price: 'Формат: индивидуальное инженерное решение',
      description:
        'Малоэтажный жилой объём с полным инженерным расчётом, КМД и продуманной логистикой поставок. Применяется для сложных и инвестиционных проектов.',
      markers: [
        'Расчёт под региональные нагрузки',
        'Паспорт партии и маркировка элементов',
        'Вариативность фасадных решений',
        'Шеф-монтаж по запросу'
      ]
    }
  ];
