        ...
        <div className="container">
          <div className="documents-info-content">
            <SectionHeader
              ...
              subtitle="Подтверждение законности деятельности и допуска к выполнению работ"
            />
            <p className="body-lg documents-info-text">
              Все представленные документы действительны и предоставляются для проверки, согласования и заключения договоров. Деятельность компании ведётся в соответствии с требованиями законодательства и отраслевых стандартов.
            </p>
          </div>
        </div>
      </section>
