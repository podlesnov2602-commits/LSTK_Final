  ...
  const gallery = [
    {
      ...
      purpose: 'Каркас дома с двумя спальнями. ',
      tag: 'ЖИЛОЙ ДОМ'
    },
    {
      image: gallery2,
      title: 'Жилой дом 72 м²',
      purpose: 'Каркас дома c плоской эксплуатируемой кровлей в современном минималистичном стиле с двумя спальнями.',
      tag: 'ЖИЛОЙ ДОМ'
    },
    {
      image: gallery3,
      title: 'Жилой дом 102,6 м²',
      purpose: 'Дом в стиле хай-тек с выносной консолью на 2 метра',
      tag: 'ЖИЛОЙ ДОМ'
    },
    {
      image: gallery4,
      title: 'Финский дом 158м²',
      purpose: 'Каркас дома в финском стиле с 3 спальнями, 2 санузлами и просторной кухней-гостиной. То, что нужно для дружной семьи.',
      tag: 'ЖИЛОЙ ДОМ'
    },
    {
      image: gallery5,
    ...
    },
     {
      ...
      purpose: 'Современный скандинавский дом с панорамным видом.',
      tag: 'ЖИЛОЙ ДОМ'
    }
  ];
