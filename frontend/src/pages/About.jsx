  ...
  const values = [
    {
      icon: Award,
      title: 'Качество',
      description: 'Используем современное оборудование и качественные материалы'
    },
    {
      icon: Users,
      title: 'Команда',
      description: 'Опытные специалисты с многолетним опытом работы'
    },
    {
      icon: Factory,
      title: 'Производство',
    ...
    },
    {
      icon: Target,
      title: 'Надёжность',
      description: 'Гарантируем качество и сроки выполнения работ'
    }
  ];
